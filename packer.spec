...
Requires: packer-plugin-amazon
Requires: packer-plugin-ansible
Requires: packer-plugin-azure
Requires: packer-plugin-docker
Requires: packer-plugin-googlecompute
Requires: packer-plugin-libvirt
Requires: packer-plugin-qemu
Requires: packer-plugin-vagrant
Requires: packer-plugin-virtualbox
Requires: packer-plugin-vmware
Requires: packer-plugin-vsphere
